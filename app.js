(() => {
  ...
  function gameMarketOwnedAutoScore(g,key){
    if(!['growth','marketMonetization'].includes(key))return {owned:false,value:null};
    ...
    return {owned:true,value:insight?.monetization5??null};
  }
